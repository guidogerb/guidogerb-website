...
describe('this-is-my-story.org automation touchpoints', () => {
  const automationConfigPath = join(
    repoRoot,
    'websites/this-is-my-story.org/automation-touchpoints.json',
  )
  ...
  it('tracks domain metadata and ensures listed files exist', () => {
    ...
    expect(domain).toBe('this-is-my-story.org')
    expect(workspaceSlug).toBe('this-is-my-story')
