        ...
        <footer className="site-footer" id="contact">
          <div>
            ...
            <p>
              ...
              <a href="tel:+12125559876">+1 (212) 555-9876</a> to discuss catalog development, distribution, or
              rights management partnerships.
            </p>
          </div>
          <div className="footer-meta">
            <p>© {new Date().getFullYear()} GuidoGerb Publishing, LLC. All rights reserved.</p>
            <p>
              Headquarters in New York with a distributed production and licensing team. Connect with us on{' '}
