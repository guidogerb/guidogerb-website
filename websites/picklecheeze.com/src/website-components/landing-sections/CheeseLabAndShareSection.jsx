export function CheeseLabAndShareSection() {
  return (
    <section className="content-grid" id="cheese-lab">
      ...
      <article>
        ...
        <p>
          Join the fermentation club to receive rotating jars, cheeze pairings, and pantry extras.
          Shares include recipe cards and playlists so every delivery becomes a dinner party.
        </p>
        <ul className="feature-list">
