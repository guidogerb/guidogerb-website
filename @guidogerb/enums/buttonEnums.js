/** @typedef {import('@guidogerb/ui-system').ButtonAppearance} ButtonAppearance */
/** @typedef {import('@guidogerb/ui-system').ButtonTypes} ButtonTypes */
/** @typedef {import('@guidogerb/ui-system').IconButtonAppearance} IconButtonAppearance */
