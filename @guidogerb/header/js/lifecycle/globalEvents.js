...
export function hideAllMenus() {
  const popupsSelectors = [
    `${getCssClassSelector(domConstants.UI_SYSTEM)} ${getCssClassSelector(domConstants.HEADER)} ${getCssClassSelector(domConstants.POPUP_WRAPPER)}`,
    `${getCssClassSelector(domConstants.UI_SYSTEM)} ${getCssClassSelector(domConstants.MAIN_MENU)} ${getCssClassSelector(domConstants.POPUP_WRAPPER)}`,
  ]
