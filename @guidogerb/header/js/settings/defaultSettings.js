 ...
 * Interact with `settings` using getHeaderSettings() and setGgpHeaderSettings().
 ...
 * to setGgpHeaderSettings. So make sure out all the required fields in this object with sensible
...
export const defaultSettings = {
  ...
  title: 'My Ggp.guidogerbpublishing.com Site',
  titleUrl: '/',
  ggpId: false,
}
