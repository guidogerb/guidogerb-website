...
import GgpOfficialWebsitePopupContentHtml from './html/GgpOfficialWebsitePopupContent.html?raw'
...
export function closeOfficialWebsite() {
  ...
  const closeButton = notNull(
    officialWebsiteWrapper.querySelector(
      getCssClassSelector(domConstants.LOGO_OFFICIAL_CLOSE_BUTTON),
    ),
...
export function renderOfficialWebsite() {
  const officialWebsiteWrapper = renderDOMSingle(GgpOfficialWebsitePopupContentHtml)
  ...
  const closeButton = officialWebsiteWrapper.querySelector(
    getCssClassSelector(domConstants.LOGO_OFFICIAL_CLOSE_BUTTON),
  )
  if (!closeButton) {
