...
- Design an automation test that runs the future `AddCF-Tenant` scaffolding, installs dependencies, executes `pnpm clean/install/build/lint/format`, and boots a preview to assert the welcome page renders.
